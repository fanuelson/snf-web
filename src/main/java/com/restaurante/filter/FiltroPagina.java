package com.restaurante.filter;
...
/*
 ...
 NECESSARIO INSERIR ESSA CONFIGURAÇAO NO ARQUIVO XML PARA QUE O FILTRO FUNCIONE
  <filter>
       <filter-name>FiltroPagina</filter-name>
       <filter-class>com.restaurante.filter.FiltroPagina</filter-class>     
   </filter>
   <filter-mapping>
      <filter-name>FiltroPagina</filter-name>
...
public class FiltroPagina implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
       ...
       String newCurrentPage = ((HttpServletRequest) request).getServletPath() + "/oi";
